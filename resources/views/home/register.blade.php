            ...
            <form action="" method="post">
                ...
                <div class="form-group">
                    <div class="signup-form">
                        <input type="text" placeholder="邮箱" class="email-mobile" onBlur="verify.verifyEmail(this)" name="email">
                ...
                <div class="signup-email">
                    ...
                    <div class="form-group">
                        <input type="password" placeholder="密码（字母、数字，至少6位）" onBlur="verify.PasswordLenght(this)" name="password">
                        <span class="error-notic">密码长度不够</span>
                    </div>
                    <div class="form-group">
                        <input type="submit" class="tran pr" style="background-color:#03A9F4;color: white;cursor:pointer;" value="注册">
...
<div class="login-footer">
    <p>Copyright© 2014-2015 Powered by <a href="http://www.17sucai.com/">新浪微博</a> </p>
