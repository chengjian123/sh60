...
@section('iframe')
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <form class="form-inline" action="{{url('admin/vipSearch')}}" method="post">
                {{csrf_field()}}
                    ...
                    @foreach($users as $userL)
                        <tr >
                            ...
                            <td >
                                ...
                                <a href="usersVipRe/{{$userL->id }}" type="button" class="btn btn-danger">重置密码</a>

                                @if($userL->disable==0)
                                    <a href="usersVipDisable/{{$userL->id }}" type="button" class="btn btn-info">已启用</a>
                                @else
                                    <a href="usersVipAble/{{$userL->id }}" type="buttn" class="btn btn-danger">已禁用 </a>
                                 @endif
