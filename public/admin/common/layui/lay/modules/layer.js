...
ready.rescollbar = function(index){
  if(doms.php.attr('layer-full') == index){
    if(doms.php[0].style.removeProperty){
      doms.php[0].style.removeProperty('overflow');
    } else {
      doms.php[0].style.removeAttribute('overflow');
    }
    doms.php.removeAttr('layer-full');
  }
};
